...
bool costom_msg__msg__wheel_speeds_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
{
  /* NOTE(esteve): Call constructor of WheelSpeedsStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("costom_msg.msg._wheel_speeds_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WheelSpeedsStamped");
