...
{
  new (message_memory) costom_msg::msg::WheelSpeedsStamped(_init);
}

void WheelSpeedsStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<costom_msg::msg::WheelSpeedsStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WheelSpeedsStamped_message_members = {
  "costom_msg::msg",  // message namespace
  "WheelSpeedsStamped",  // message name
  1,  // number of fields
  sizeof(costom_msg::msg::WheelSpeedsStamped),
...
{
  return &::costom_msg::msg::rosidl_typesupport_introspection_cpp::WheelSpeedsStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, costom_msg, msg, WheelSpeedsStamped)() {
  return &::costom_msg::msg::rosidl_typesupport_introspection_cpp::WheelSpeedsStamped_message_type_support_handle;
}
