...
#include "costom_msg/msg/detail/wheel_speeds_stamped__rosidl_typesupport_fastrtps_c.h"
...
#include "costom_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _WheelSpeedsStamped__ros_msg_type = costom_msg__msg__WheelSpeedsStamped;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_costom_msg
size_t get_serialized_size_costom_msg__msg__WheelSpeedsStamped(
  const void * untyped_ros_message,
...
static uint32_t _WheelSpeedsStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_costom_msg__msg__WheelSpeedsStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_costom_msg
size_t max_serialized_size_costom_msg__msg__WheelSpeedsStamped(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_costom_msg__msg__WheelSpeedsStamped(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, costom_msg, msg, WheelSpeedsStamped)() {
